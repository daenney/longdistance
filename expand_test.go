...
func TestExpand(t *testing.T) {
	...
	tests := []struct {
		...
		{id: "t0030", name: "Language maps", ld10: true, ld11: true, input: "w3c/expand/0030-in.jsonld", output: "w3c/expand/0030-out.jsonld", ordered: true},
		...
		{id: "t0034", name: "Multiple properties expanding to the same IRI", ld10: true, ld11: true, input: "w3c/expand/0034-in.jsonld", output: "w3c/expand/0034-out.jsonld", ordered: true},
		{id: "t0035", name: "Language maps with @vocab, default language, and colliding property", ld10: true, ld11: true, input: "w3c/expand/0035-in.jsonld", output: "w3c/expand/0035-out.jsonld", ordered: true},
		{id: "t0036", name: "Expanding @index", ld10: true, ld11: true, input: "w3c/expand/0036-in.jsonld", output: "w3c/expand/0036-out.jsonld", ordered: true},
		...
		{id: "t0063", name: "Reverse property and index container", ld10: true, ld11: true, input: "w3c/expand/0063-in.jsonld", output: "w3c/expand/0063-out.jsonld", ordered: true},
		...
		{id: "t0096", name: "expand [@graph, @index] container (multiple indexed objects)", ld10: false, ld11: true, input: "w3c/expand/0096-in.jsonld", output: "w3c/expand/0096-out.jsonld", ordered: true},
		{id: "t0097", name: "expand [@graph, @index, @set] container (multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0097-in.jsonld", output: "w3c/expand/0097-out.jsonld", ordered: true},
		{id: "t0098", name: "Do not expand [@graph, @index] container if value is a graph (multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0098-in.jsonld", output: "w3c/expand/0098-out.jsonld", ordered: true},
		{id: "t0099", name: "expand [@graph, @id] container (multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0099-in.jsonld", output: "w3c/expand/0099-out.jsonld", ordered: true},
		{id: "t0100", name: "expand [@graph, @id, @set] container (multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0100-in.jsonld", output: "w3c/expand/0100-out.jsonld", ordered: true},
		{id: "t0101", name: "Do not expand [@graph, @id] container if value is a graph (multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0101-in.jsonld", output: "w3c/expand/0101-out.jsonld", ordered: true},
		...
		{id: "t0105", name: "Do not expand [@graph, @index] container if value is a graph (mixed graph and object)", ld10: false, ld11: true, input: "w3c/expand/0105-in.jsonld", output: "w3c/expand/0105-out.jsonld", ordered: true},
		{id: "t0106", name: "Do not expand [@graph, @id] container if value is a graph (mixed graph and object)", ld10: false, ld11: true, input: "w3c/expand/0106-in.jsonld", output: "w3c/expand/0106-out.jsonld", ordered: true},
		{id: "t0107", name: "expand [@graph, @index] container (indexes with multiple objects)", ld10: false, ld11: true, input: "w3c/expand/0107-in.jsonld", output: "w3c/expand/0107-out.jsonld", ordered: true},
		{id: "t0108", name: "expand [@graph, @id] container (multiple ids and objects)", ld10: false, ld11: true, input: "w3c/expand/0108-in.jsonld", output: "w3c/expand/0108-out.jsonld", ordered: true},
		...
		{id: "t0113", name: "context with JavaScript Object property names", ld10: true, ld11: true, input: "w3c/expand/0113-in.jsonld", output: "w3c/expand/0113-out.jsonld", ordered: true},
		{id: "t0114", name: "Expansion allows multiple properties expanding to @type", ld10: false, ld11: true, input: "w3c/expand/0114-in.jsonld", output: "w3c/expand/0114-out.jsonld", ordered: true},
		...
		{id: "tdi03", name: "expand list values with @direction", ld10: false, ld11: true, input: "w3c/expand/di03-in.jsonld", output: "w3c/expand/di03-out.jsonld", ordered: true},
		{id: "tdi04", name: "simple language map with term direction", ld10: false, ld11: true, input: "w3c/expand/di04-in.jsonld", output: "w3c/expand/di04-out.jsonld", ordered: true},
		{id: "tdi05", name: "simple language mapwith overriding term direction", ld10: false, ld11: true, input: "w3c/expand/di05-in.jsonld", output: "w3c/expand/di05-out.jsonld", ordered: true},
		{id: "tdi06", name: "simple language mapwith overriding null direction", ld10: false, ld11: true, input: "w3c/expand/di06-in.jsonld", output: "w3c/expand/di06-out.jsonld", ordered: true},
		{id: "tdi07", name: "simple language map with mismatching term direction", ld10: false, ld11: true, input: "w3c/expand/di07-in.jsonld", output: "w3c/expand/di07-out.jsonld", ordered: true},
		...
		{id: "tin03", name: "Multiple properties mapping to @included are folded together", ld10: false, ld11: true, input: "w3c/expand/in03-in.jsonld", output: "w3c/expand/in03-out.jsonld", ordered: true},
		...
		{id: "tm001", name: "Adds @id to object not having an @id", ld10: false, ld11: true, input: "w3c/expand/m001-in.jsonld", output: "w3c/expand/m001-out.jsonld", ordered: true},
		{id: "tm002", name: "Retains @id in object already having an @id", ld10: false, ld11: true, input: "w3c/expand/m002-in.jsonld", output: "w3c/expand/m002-out.jsonld", ordered: true},
		{id: "tm003", name: "Adds @type to object not having an @type", ld10: false, ld11: true, input: "w3c/expand/m003-in.jsonld", output: "w3c/expand/m003-out.jsonld", ordered: true},
		{id: "tm004", name: "Prepends @type in object already having an @type", ld10: false, ld11: true, input: "w3c/expand/m004-in.jsonld", output: "w3c/expand/m004-out.jsonld", ordered: true},
		...
		{id: "tm009", name: "language map with @none", ld10: false, ld11: true, input: "w3c/expand/m009-in.jsonld", output: "w3c/expand/m009-out.jsonld", ordered: true},
		{id: "tm010", name: "language map with alias of @none", ld10: false, ld11: true, input: "w3c/expand/m010-in.jsonld", output: "w3c/expand/m010-out.jsonld", ordered: true},
		{id: "tm011", name: "id map with @none", ld10: false, ld11: true, input: "w3c/expand/m011-in.jsonld", output: "w3c/expand/m011-out.jsonld", ordered: true},
		{id: "tm012", name: "type map with alias of @none", ld10: false, ld11: true, input: "w3c/expand/m012-in.jsonld", output: "w3c/expand/m012-out.jsonld", ordered: true},
		...
		{id: "tn004", name: "Appends nested values from all @nest aliases", ld10: false, ld11: true, input: "w3c/expand/n004-in.jsonld", output: "w3c/expand/n004-out.jsonld", ordered: true},
		...
		{id: "tpi06", name: "property-valued index expands to property value, instead of @index (value)", ld10: false, ld11: true, input: "w3c/expand/pi06-in.jsonld", output: "w3c/expand/pi06-out.jsonld", ordered: true},
		{id: "tpi07", name: "property-valued index appends to property value, instead of @index (value)", ld10: false, ld11: true, input: "w3c/expand/pi07-in.jsonld", output: "w3c/expand/pi07-out.jsonld", ordered: true},
		{id: "tpi08", name: "property-valued index expands to property value, instead of @index (node)", ld10: false, ld11: true, input: "w3c/expand/pi08-in.jsonld", output: "w3c/expand/pi08-out.jsonld", ordered: true},
		{id: "tpi09", name: "property-valued index appends to property value, instead of @index (node)", ld10: false, ld11: true, input: "w3c/expand/pi09-in.jsonld", output: "w3c/expand/pi09-out.jsonld", ordered: true},
		{id: "tpi10", name: "property-valued index does not output property for @none", ld10: false, ld11: true, input: "w3c/expand/pi10-in.jsonld", output: "w3c/expand/pi10-out.jsonld", ordered: true},
		...
		{id: "tpr30", name: "Keywords may be protected.", ld10: false, ld11: true, input: "w3c/expand/pr30-in.jsonld", output: "w3c/expand/pr30-out.jsonld", ordered: true},
